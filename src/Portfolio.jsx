...
const REEL_DESCS = {
  ...
  // Caption-sourced (Miles's published words, trimmed); R1 polishes awkward ones.
  ...
  "’24 IBC: Premiere Pro Release (Customer Interviews)": "Releasing (beta) innovations? The likely thing for us to do.",
  "’24 IBC: Event Recap": "We're all heading back into the office, but emotionally, we're still at! Check out some of our fave highlights, including the latest cinema camera releases from @CanonUSA and @Sony and, of course, our",
  ...
  "’24 MAX: Project Generative Physics": "Create life in your scenes with a single click with Project Generative Physics! In this Adobe Research Sneak, realistic physics are a snap with a simple text prompt that can generate subjects which in",
  "’24 MAX: In-Office Trivia": "How much do YOU know about? In addition to having amazing Sneaks, it's the perfect place to brush up on your creative skills and learn some new ones",
  "’24 MAX: Attendee Scavenger Hunt": "They come from near and far, but our incredible community all agrees... the best thing about is everything!",
  "’24 MAX: 3 Things We Didn’t Expect": "From secret escape rooms to birthday ambushes, was full of surprises! What captured your delight or broke your brain over the past few days?",
  "’24 MAX: Sneaks Reactions One Emoji": "Sneaks = next-level creativity. Drop one emoji that sums up the mind-blowing, creative magic we witnessed this year, and learn more about each Sneak at the",
  "’24 MAX: Beyond Your Job Title": "What our moms think our job is: vs what it really is: ⏱",
  "’24 MAX: Photoshop New Feature Demo": "At MAX, we unveiled the latest Photoshop tools, and they’re already making waves! Detect distractions like wires and cables or people, add 3D objects to 2D spaces, and try the enhanced Generative Exte",
  "’24 MAX: Premiere Pro Demo": "Still reeling from! From dropping Generative Extend in (beta) to 's Generate Video (beta), the future of video editing is looking bright",
  "’24 MAX: Adobe x Gatorade Activation": "In case you missed this iconic partnership at the event, @gatorade and have teamed up to take your hydration game to the next level. Customize your own water bottle today at the",
  "’24 NAB: Emoji Reaction Interviews": "powered by is coming to! Drop an emoji that sums up your reaction",
  ...
  "’25 Summit: Coca-Cola Activation": "\"Crisp.\" \"Refreshing.\" \"Legendary.\" Overheard at describing our iconic partnership with @cocacola, as well as Miles' bow tie",
  ...
  "’25 Summit: “Describe Your Job” Interviews": "No titles, no problem. We put attendees on the spot, and their answers were priceless!",
  "’25 Summit: Coolest Job @Adobe S1": "“Who do you think has the coolest job at Adobe?” Easy question, right? Not when you’re surrounded by amazing coworkers.",
  "’25 Summit: Sneaks Emoji Reactions": "Big ideas, bold innovations! We unveiled potential new features at Sneaks on the keynote stage, and our dedicated correspondent Miles was on the ground capturing attendee reactions.",
  "’25 Summit: Hosted Event Recap": "Have you heard that ’s celebrity host @KenJeong can’t stop talking about this new technology? Agentic AI blew us away this year and totally stole the spotlight.",
  "’25 Summit: Ken Jeong Interview": "Decisions, decisions… We put @kenjeong through our @AdobeExpress quadrants icebreaker, and let’s just say—he understood the assignment! From AI to hotel splurges to the great soda vs.",
  "’25 Summit: Escalator ‘Hot’ Takes": "We asked the experts at to serve up their best rapid-fire insights on agentic AI. The takeaway?",
  "’25 MAX: Acrobat Booth": "The snack thief doesn't stand a chance against Acrobat Studio",
  ...
  "’25 MAX: Kelley O'Hara x NWSL x Adobe": "From the pitch to producing, former @NWSL athlete @kelleyohara is redefining success. We are teaming up with Kelley, who is using our tools to empower her next chapter, growing the game, on and off th",
  "’25 MAX: Mark Rober’s Creator Assignment": "\"Your most viral clips are the ones that create the biggest visceral response.\" keynote speaker @markrober offers advice on how to level up your content. PSA to creators: use the same viral strategies",
  "’25 MAX: Jessica Williams’ Creator Assignment": "“Follow your instinct, not the trends. Sneaks host @msjwilly reminds us that our instinct is the most powerful thing we can tap into as creators. ⭐ This Emmy-nominated comedian has an assignment for y",
  ...
  "’25 MAX: Sarah Shen’s Coolest Job": "Designing generative AI tools for creators looks like this Sarah Shen, Director of Design for @adobefirefly, shares how she connects cutting-edge technology with real creative needs. From exploring ge",
  "’25 MAX London: Recap": "No matter where you traveled from, we’re so grateful you’re part of our bold, brilliant creative community. Thanks for making London unforgettable.",
  "’25 MAX London: Fonts Creator Game": "Helvetica vs. Times New Roman: the ultimate font-off.",
  "’25 MAX London: Firefly Explainer": "We stopped in at London to reveal 5 simple steps to better prompts for video generation. Let's see what fun scenes we came up with using the latest updates in.",
  "’25 NAB: Premiere Pro Releases": "Brewing groundbreaking innovations = our cup of tea. Steep yourself in all the buzz as we recap your favorite new features",
  ...
  "’25 NAB: Event Coverage": "Out: Scouring your media library for a misplaced shot In: Empowering your editing workflow with Media Intelligence Using casual language, you can search for filmed subject matter, video specs, and mor",
  ...
  "Russell Preston Brown Employee Spotlight": "Meet Russell Preston Brown, Senior Principal Designer, who has worked at Adobe for 41 years! Outside the office, Russell is a costume maker, designer, and photographer whose curiosity for art and scie",
  ...
  "Em Siegel Employee Spotlight": "Meet @ecs.ceramics, Staff Product Designer at Adobe. Outside of work, Em is a ceramicist.",
  ...
  "Coolest Job: Tongyu": "Game on. Adobe Research Scientist Tongyu Zhou levels up her passion for gaming through the projects she leads every day at Adobe",
  "Brand Intelligence B2B Interview": "At, we introduced Adobe Brand Intelligence. It took a diverse team of individuals from all over the globe at different stages of their careers to work together and launch something this big into the m",
  ...
  "San Jose Semaphore": "The San Jose Semaphore has been solved! The puzzle, created by Ben Rubin, featured rotating discs at the top of Adobe’s Almaden Tower that hid a message through data points of bytes and numbered color",
  "’26 Summit: Recap": "We went backstage at to chat with @ilizas, comedian and celebrity co-host of Adobe Sneaks. Here’s what she had to say about creativity, failure, and technology",
};
...
const ALBUM_BLURBS = {
  // Miles's own lines stay verbatim; the rest drafted from data + Workfront
  // briefs (gate-compliant, no em dashes, no invented numbers). R1 reviews.
