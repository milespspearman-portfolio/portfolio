# IG / video links for the 84→100 add — session Jul 4–5, 2026

Confirmed in Chrome (Browser 3, logged in). Ready for the Apify download batch **once the set is complete** (Miles's gate: Apify only after all IG links found). Standing rule on each fetch: correct year/event folder + thumb + AUDIO check + Notion row.

## CONFIRMED — Instagram
| Item | Handle | URL | Note |
|---|---|---|---|
| Building Murals (Laura Garcia) | @adobe × @adobelife | https://www.instagram.com/reel/DRQpeMIjeCw/ | Nicaraguan-roots SF-office window mural, ~545K plays |
| NWSL Creator Club | @adobe | https://www.instagram.com/reel/DNRX89SpIkC/ | Adobe × @NWSL 2025 Creator Club (the Kelley / NWSL hero item) |
| Marvel Eyes of Wakanda | @photoshop | https://www.instagram.com/reel/DOWitx1Afr1/ | custom-brushes promo, links to the YT longform (Miles-provided) |
| NFL Kickoff (carousel) | @adobe (+@adobeexpress) | https://www.instagram.com/p/DOPM4FmkpE_/ | Sep 5 2025, "Creativity is officially on the field" (Miles-provided) |

## LONGFORM — YouTube (candidate Longform row / Adobe pro)
| Item | URL | Views |
|---|---|---|
| NFL "Made to Create" / LCC | https://www.youtube.com/watch?v=emLfQR3DPME | 484K |
